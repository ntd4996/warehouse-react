...
const localeInfo = {
  'en-US': {
    messages: require('/Users/sonld/Desktop/base/ant_kwmc/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: require('/Users/sonld/Desktop/base/ant_kwmc/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
