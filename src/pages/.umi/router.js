  ...
  },
  {
    ...
    "routes": [
      ...
      },
      {
        ...
        "icon": "caret-down",
        "component": dynamic({ loader: () => import('../ChiTietDuyet/ChiTietDuyet'), loading: require('/Users/macbookpro/Desktop/warehouse-react/src/components/PageLoading/index').default }),
        "exact": true
      },
      {
      ...
      },
      {
        ...
        "name": "dd",
        "icon": "dashboard",
        "component": dynamic({ loader: () => import('../DuyetDon/DuyetDon'), loading: require('/Users/macbookpro/Desktop/warehouse-react/src/components/PageLoading/index').default }),
        "exact": true
      },
      {
        "component": () => React.createElement(require('/Users/macbookpro/Desktop/warehouse-react/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
